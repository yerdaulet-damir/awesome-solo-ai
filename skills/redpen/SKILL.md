...
description: >
  ...
  tests before it ships. Use on any headline, landing page, tweet, email,
  cold-open, tagline, or product name. Triggers: /redpen, "write copy",
  "improve this headline", "make this not sound like slop", "rewrite this line".
...
3. **Can nobody else say it?** Could a competitor sign this exact line? If yes,
   ...
   Volvo can say that. Never write an ad a competitor can sign.
...
- **Kaplan's Law of Words.** Any word that isn't working for you is working
  against you. Cross it out. Same for ideas: strength is inversely proportional
  to scope — the word "and" on a landing page is usually a leak. Do one thing.
...
Rewritten line(s) first. Then at most three short lines: which test the original
failed, and the one move that fixed it. If your explanation is longer than the
copy, delete the explanation — every paragraph defending a line is slop smuggled
back in as prose. Give 2–3 variants when the user wants options; label the
strongest first.
...
Never cut for punch at the cost of truth. Do not invent a "fact" to pass test
two — research it or don't claim it. Leave intact: legal disclaimers, medical/
financial accuracy, safety warnings, accessibility labels, required regulatory
language, and any technical spec where precision beats punch. Concrete never
means dishonest.
