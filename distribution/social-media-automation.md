...
- [x-autonomous-mcp](https://github.com/JohannesHoppe/x-autonomous-mcp) by [Johannes Hoppe](https://github.com/JohannesHoppe), MCP server for the X API with daily budgets, engagement deduplication, and human approval controls. mcp, twitter, safety rails, mit.
