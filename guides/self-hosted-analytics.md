...
- [Highlight](https://github.com/highlight/highlight) by [Highlight](https://github.com/highlight), an open-source observability platform combining session replay, error monitoring, logging, and distributed tracing. open source, self hosted, session replay, monitoring.
